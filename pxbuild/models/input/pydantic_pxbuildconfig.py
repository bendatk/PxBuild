...
#   timestamp: 2025-07-03T07:45:40+00:00
...
class PxMetadataResource(BaseModel):
    ...
    This defaults to file. Which currently is the only working value.
    """
    adress_format: Union[str, Dict[str, Any]] = Field(..., alias='adressFormat')
...
class PxDataResource(BaseModel):
    ...
    resource_type: Optional[ResourceType3] = Field('file', alias='resourceType')
...
class Admin(BaseModel):
    ...
    """
    make_support_files: Optional[bool] = Field(True, alias='makeSupportFiles')
    """
    If True, the pxbuild will create support files like vs and agg files.
    """
